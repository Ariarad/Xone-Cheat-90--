...
void CGHelper::ChangeGHI(GHInfo* info, char NameBuf[], char DescpBuf[], char MapName[], bool AdvMap)
{
	...
	if (AdvMap)
	{
		...
		X1Gui().ComboBox(!MainSettings().Russian ? XorStr("Map") : XorStr(u8"�����"), &SelecteMapMode, itemsGHSS);

		if (SelecteMapMode == 1)
		{
			X1Gui().InputText(!MainSettings().Russian ? XorStr("Map Name") : XorStr(u8"��� �����"), MapName, 300);
		}
...
#define chu(e)  e
	...
	//X1Gui().Separator();
	//X1Gui().Spacing();
	//X1Gui().Text(!MainSettings().Russian ? XorStr("Description:") : XorStr(u8"��������:"));
...
/*	strcpy(DescpBuf, info->descn.c_str());
	...
	//DCheckBox("Show Direction", u8"���������� �����������", info->show_direction, u8"");	
};
...
//	GP_IRender->render_String(17, Vec2(100, 100), Color::Red().GetImColor(), DT_LEFT, to_string(all).c_str());
	...
	X1Gui().Spacing();
	SliderFloats("Distance Show Info", u8"��������� ����������� ����������", DistShowInfo, 1, 400, u8"");
	SliderFloats("Distance Show", u8"��������� �����������", DistShowHelp, 1, 2000, u8"");
	...
	if (Mode == 0)
	{
		...
		if (SelectedGHInf)
		{
			...
			if (CurMap)
			{
				...
				if (X1Gui().Button(!MainSettings().Russian ? XorStr("Remove") : XorStr(u8"�������"), Vec2(long_item_w, 22)))
					if (CurMap)
						RemvMapHelp(CurMap, SelectedGHInf);
			}
		}
	...
	else if (Mode == 1)
	{
		...
		if (X1Gui().Button(!MainSettings().Russian ? XorStr("Add") : XorStr(u8"��������"), Vec2(long_item_w, 22)))
		{
	...
	X1Gui().Separator();
	X1Gui().Spacing();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Load Grenade Helper") : XorStr(u8"��������� ��������"), Vec2(228, 22)))
	{
		if (LoadMaps());
		//	Menu::Message::Get().Start(!MainSettings().Russian ? XorStr("Settings loaded!") : XorStr(u8"��������� ���������!"));
		//else
		//	Menu::Message::Get().Start(!MainSettings().Russian ? XorStr("Error load!") : XorStr(u8"������ ��������!"));
	}
	X1Gui().SameLine();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Save Grenade Helper") : XorStr(u8"��������� ��������"), Vec2(228, 22)))
	{
		if (SaveMaps());
		//	Menu::Message::Get().Start(!MainSettings().Russian ? XorStr("Settings saved!") : XorStr(u8"��������� ���������!"));
		//else
		//	Menu::Message::Get().Start(!MainSettings().Russian ? XorStr("Error save!") : XorStr(u8"������ ����������!"));	
	}
	X1Gui().Spacing();
	X1Gui().Separator();
	X1Gui().Spacing();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Reset Settings Grenade Helper") : XorStr(u8"�������� ��������� ��������"), Vec2(long_item_w, 22)))
	{
		maps.clear();
		SelectedGHInf = nullptr;
		SelectedMap = nullptr;
