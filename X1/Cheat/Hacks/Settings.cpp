...
void CGSettings::Menu()
{
	...
	if(X1Gui().ListBoxHeader(XorStr("##0"), Vec2(long_item_w, 250)))
	{
		...
		for (int i = 0; i < (int)AllSettings.size(); i++)
		{
			...
			if (!AllSettings[i].cloud_hash.empty())
			{
				...
				if (X1Gui().Button(((!MainSettings().Russian ? XorStr("Copy##") : XorStr(u8"�����.##")) + AllSettings[i].cloud_hash).c_str(), Vec2(0, 19)))
				{
	...
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Create & Save new Settings") : XorStr(u8"������� � ��������� ����� ���������")))
	{
		//CheckRus
		if (!CheckRus(string(NewConfigName)))
		{
			...
			if (Save(ConfigFileName + SettingsFormat))
				Message::Get().Start(!MainSettings().Russian ? XorStr("Settings saved!") : XorStr(u8"��������� ���������!"));
			else
				Message::Get().Start(!MainSettings().Russian ? XorStr("Error save!") : XorStr(u8"������ ����������!"));

			UpdateList();
			strcpy(NewConfigName,"");
		}
		//else
		//	Menu::Message::Get().Start(!MainCheatConfig.RusLanguage ? XorStr("Error save(RUS)!") : XorStr(u8"������ ����������(RUS)!"));
	}
	X1Gui().Spacing();
	X1Gui().InputText(XorStr("##Hash"), NewConfigHash, 28);
	X1Gui().SameLine();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Load Shared Settings") : XorStr(u8"��������� ����� ���������")))
	{
		...
		if (!_shared_finded && !string(NewConfigHash).empty() && CloudLoad(string(NewConfigHash), _shared_name))
		{
			...
			UpdateList();
			Message::Get().Start(!MainSettings().Russian ? XorStr("Settings loaded!") : XorStr(u8"��������� ���������!"));
		}
		else
			Message::Get().Start(!MainSettings().Russian ? XorStr("Error load!") : XorStr(u8"������ ��������!"));
	}
	...
	if (ConfigSelect >= 0 && ConfigSelect < (int)AllSettings.size())
	{
		if (!AllSettings[ConfigSelect].cloud && !AllSettings[ConfigSelect].pc_cloud)
		{
			...
			X1Gui().Separator();
			X1Gui().Spacing();
			if (X1Gui().Button(!MainSettings().Russian ? XorStr("Upload settings to the server") : XorStr(u8"��������� ��������� �� ������"), Vec2(long_item_w, 0)))
			{
				string JCont = readFile(SettignBaseDir + AllSettings[ConfigSelect].name);

				if (JCont == string(XorStr("Read Error")))
					Message::Get().Start(!MainSettings().Russian ? XorStr("Error upload!") : XorStr(u8"������ ��������!"));
				else
				{
	...
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Update Settings List") : XorStr(u8"�������� ������ ��������"), Vec2(long_item_w, 0)))
	{
		UpdateList();
		Message::Get().Start(!MainSettings().Russian ? XorStr("List updated!") : XorStr(u8"������ ��������!"));
	}
	...
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Save Settings") : XorStr(u8"��������� ���������"), Vec2(long_item_w, 0)))
	{
		if (ConfigSelect >= 0 && ConfigSelect < (int)AllSettings.size())
		{
	...
	X1Gui().Spacing();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Load Settings") : XorStr(u8"��������� ���������"), Vec2(long_item_w, 0)))
	{
		if (ConfigSelect >= 0 && ConfigSelect < (int)AllSettings.size())
		{
			SetName(SettignBaseDir + AllSettings[ConfigSelect].name);
	...
	X1Gui().Separator();
	X1Gui().Spacing();
	if (X1Gui().Button(!MainSettings().Russian ? XorStr("Delete Settings") : XorStr(u8"������� ���������"), Vec2(long_item_w, 0)))
	{
		if (ConfigSelect >= 0 && ConfigSelect < (int)AllSettings.size())
		{
			...
			UpdateList();
			Message::Get().Start(!MainSettings().Russian ? XorStr("Settings delited!") : XorStr(u8"��������� �������!"));
		}
	}
	...
	//DCheckBox("Backup Settings", u8"��������� ����������� ��������", MainCheatConfig.BackupSettings, u8"");
