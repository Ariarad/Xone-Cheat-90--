...
void CSkins::Menu()
{
	...
	if (SkinSettingsMode == 0)
	{
		...
		if (X1Gui().Button(true ? XorStr("Update") : XorStr(u8"��������"), Vec2(long_item_w, 22)))
		{
			UpdateSkins();
			Message::Get().Start(!MainSettings().Russian ? XorStr("Updated!") : XorStr(u8"���������!"));
		}
			...
			X1Gui().BeginGroup();
			{
				...
				else if (WItem->Skin.skins_mode == 1)
				{
					...
					else
					{
						...
						X1Gui().Text(true ? XorStr("Loading skins...") : XorStr(u8"�������� ������..."));
						X1Gui().ListBoxFooter();
					}
		...
		{
			DCheckBox("Stikers", u8"�������##2432134", WeaponNames[SelectedWeapon].Skin.striker_enable, u8"");
			if (WeaponNames[SelectedWeapon].Skin.striker_enable)
			{
				...
				else if (StikersMode == 1)
				{
					...
					{
						X1Gui().Text(true ? XorStr("Loading stickers...") : XorStr(u8"�������� ��������..."));
					}
				}
