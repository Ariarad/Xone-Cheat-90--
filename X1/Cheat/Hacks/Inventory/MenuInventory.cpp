...
void CInventory::Menu()
{
	...
	auto SkinParams = [&](SkinSettings &Item) -> void
	{
		...
		X1Gui().SliderFloat(!MainSettings().Russian ? XorStr("Wear") : XorStr(u8"������������"), &Item.wear, 0.f, 2.f, "%.9f");
	...
	if (WeaponNames.size() > 0)
	{
		...
		if (InvSettingsMode == 0)
		{
			...
			if (GP_Skins)
			{
				if (WeapSkinSettingsMode == 0)
				{
					...
					X1Gui().BeginGroup();
					{
						...
						else if (WItem->Skin.skins_mode == 1)
						{
							...
							{
								X1Gui().Text(!MainSettings().Russian ? XorStr("Loading skins...") : XorStr(u8"�������� ������..."));
							}
				...
				{
					DCheckBox("Stikers", u8"�������##2432134", WItem->Skin.striker_enable, u8"");
					if (WItem->Skin.striker_enable)
					{
						...
						VectorEx<const char* > itemssmEng = { lolc("All") ,lolc("Distributed") };
						VectorEx<const char* > itemssmRus = { lolc(u8"���") ,lolc(u8"��������������") };
						DComboBox("Stickers##vod65657", u8"�������##���765657", StikersMode, itemssmEng, itemssmRus, "");
						static char FindBuf[128] = { 0 };
						...
						else if (StikersMode == 1)
						{
							...
							{
								X1Gui().Text(!MainSettings().Russian ? XorStr("Loading stickers...") : XorStr(u8"�������� ��������..."));
							}
						}
		...
		else if (InvSettingsMode == 4)
		{
			...
			DComboBox("Rank", u8"����", ProfileRank, RankList, RankList, "");
			X1Gui().Spacing();
			X1Gui().Separator();
			X1Gui().Spacing();

			SliderInts("Private LVL", u8"��������� �������", ProfileLevel, 1, 40, u8"");
			SliderInts("XP", "XP", ProfileXP, 1, 10000, u8"");
			X1Gui().Spacing();
			X1Gui().Separator();
			X1Gui().Spacing();
			SliderInts("Wins", u8"������", ProfileWins, 1, 10000, u8"");
			X1Gui().Spacing();
			X1Gui().Separator();
			X1Gui().Spacing();
			SliderInts("Friendly", u8"�����������", ProfileFriendly, 1, 10000, u8"");
			SliderInts("Leader", u8"�����", ProfileLeader, 1, 10000, u8"");
			SliderInts("Teacher", u8"�������", ProfileTeacher, 1, 10000, u8"");
			X1Gui().Spacing();
			X1Gui().Separator();
			X1Gui().Spacing();
...
void CInventory::InvListMenu()
{
	...
	if ((int)InventoryList.size() > 0 && InventSelectItem > -1 && InventSelectItem < (int)InventoryList.size())
	{
		...
		//VectorEx<const char* > InventoryTypes = { lolc(u8"���������"), lolc(u8"������������ ��������"),lolc(u8"��������� ��������"), lolc(u8"�����������"),
		//	lolc(u8"�������������"), lolc(u8"������"), lolc(u8"�����������") };
		//X1Gui().Combo(!MainSettings().Russian ? XorStr("Rarity") : XorStr(u8"������������"), &InventoryList[InventSelectItem].Rarity, InventoryTypes, IM_ARRAYSIZE(InventoryTypes));
		////X1Gui().SameLine();
		//X1Gui().SliderFloat(!MainSettings().Russian ? XorStr("Quality") : XorStr(u8"��������"), &InventoryList[InventSelectItem].Wear, 0.000f, 1.f, "%.9f");
		...
		if (X1Gui().Button(!MainSettings().Russian ? XorStr("Update Inventory") : XorStr(u8"�������� ���������"), Vec2(long_item_w, 22)))
		{
			SendClientHello();
		}
		X1Gui().Spacing();
		if (X1Gui().Button(!MainSettings().Russian ? XorStr("Remove") : XorStr(u8"�������"), Vec2(175, 22)))
		{
		...
		X1Gui().SameLine();
		if (X1Gui().Button(!MainSettings().Russian ? XorStr("Remove all") : XorStr(u8"������� ���"), Vec2(176, 22)) && InventoryList.size() > 0)
		{
			SendClientHello();
			InventoryList.clear();
