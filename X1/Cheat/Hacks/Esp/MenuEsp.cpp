...
void CEsp::Menu()
{
	auto LMenu = [&]()->void
	{
		...
		if (VisType == 1)
		{
			...
			DCheckBox("Grenade", u8"�������", WorldGrenade, u8"���������� �������");
			if (WorldGrenade)
			{
				...
				DColorEdit("HE Grenade", u8"���������� �������", HEGrenadeColor);
				X1Gui().SameLine(SAME_LINE_2);
				DColorEdit("Molotov Grenade", u8"�������� ��������", MolotovGrenadeColor);

				DColorEdit("Flash Grenade", u8"�������� �������", FlashGrenadeColor);
				X1Gui().SameLine(SAME_LINE_2);
				DColorEdit("Inc Grenade", u8"������������� �������", IncGrenadeColor);
			...
			X1Gui().Separator();
			X1Gui().Spacing();
			DCheckBox("Weapon", u8"������", WorldWeapons, u8"���������� ������ �� �����");
			if (WorldWeapons)
			{
				X1Gui().SameLine(SAME_LINE_1);
				X1Gui().PushItemWidth(PUSH_1);
			...
			X1Gui().Separator();
			X1Gui().Spacing();
			DCheckBox("Granade Prediction", u8"���������� �������", GranadePrediction, u8"���������� ���������� ������ �������");
		...
		else if (VisType == 0)
		{
			...
			X1Gui().SameLine(SAME_LINE_2);
			DCheckBox("Only Visible", u8"������ �������", BoxVisbleOnly, u8"�������� ������ �� �������");
			...
			if (BoxEnable)
			{
				...
				DColorEdit("Color CT", u8"���� ��", BoxCT);
				X1Gui().SameLine(100);
				DColorEdit("Color T", u8"���� �", BoxTT);

				X1Gui().SameLine(200);

				DColorEdit("Visible Color CT", u8"������� ���� ��", BoxVisbleCT);
				X1Gui().SameLine(340);
				DColorEdit("Visible Color T", u8"������� ���� �", BoxVisbleTT);
			}
			...
			if (Chams)
			{
				...
				DCheckBox("Only Visible##chams", u8"�������##����", ChamsVisbleOnly, u8"������ ������� �����");
				...
				X1Gui().Spacing();
				DColorEdit("Color CT##chams", u8"���� ��##����", ChamsCT);
				X1Gui().SameLine(100);
				DColorEdit("Color T##chams", u8"���� �##����", ChamsTT);

				X1Gui().SameLine(200);

				DColorEdit("Visible Color CT##chams", u8"������� ���� ��##����", ChamsVisbleCT);
				X1Gui().SameLine(340);
				DColorEdit("Visible Color T##chams", u8"������� ���� �##����", ChamsVisbleTT);
			}
			...
			X1Gui().Separator();
			X1Gui().Spacing();
			DCheckBox("Flashing", u8"����������", Flashing, u8"�������� ���� ����� ��������");
			X1Gui().SameLine();
			DCheckBox("Defusing", u8"��������", Defusing, u8"�������� ���� ����� �������");
			X1Gui().SameLine();
			DCheckBox("Scope", u8"������������", Scope, u8"�������� ���� ����� ����������");
			X1Gui().Spacing();
			X1Gui().Separator();
			X1Gui().Spacing();

			DCheckBox("Head Esp", u8"������", HeadEsp, u8"�������� ���� ������ ������");
			if (HeadEsp)
			{
				X1Gui().SameLine(SAME_LINE_1);
			...
			X1Gui().Separator();
			X1Gui().Spacing();
			DCheckBox("Sound Esp", u8"�������� ���", SoundEspEnable, u8"�������� ����������� �����");
			if (SoundEspEnable)
			{
				X1Gui().SameLine(SAME_LINE_1);
